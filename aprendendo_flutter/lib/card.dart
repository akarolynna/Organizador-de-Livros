...
class CardLivro extends StatelessWidget {
 ...
 // const CardLivro(this.titulo, this.capitulosTotais, this.capitulosLidos, {super.key});
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          titulo, // Usa o título passado pelo construtor
                          style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 20),
                        ),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(left: 20, top: 8), // Menos padding superior
                        child: Text('Capítulos Totais: $capitulosTotais'),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(left: 20, top: 8), // Menos padding superior
